...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(modus-operandi-tinted
   ...
   dotspacemacs-mode-line-theme '(doom :separator wave :separator-scale 1.1)
  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(ace-link aggressive-indent all-the-icons auto-compile auto-highlight-symbol
                ...
                column-enforce-mode company-c-headers company-shell
                cpp-auto-include csv-mode cython-mode define-word devdocs diff-hl
                diminish dired-quick-sort disable-mouse disaster doom-modeline
                ...
                evil-visualstar expand-region eyebrowse fancy-battery fish-mode
                flycheck-bashate flycheck-elsa flycheck-package flycheck-pos-tip
                flyspell-correct-helm gendoxy gh-md git-link git-messenger
                ...
                hybrid-mode indent-guide info+ insert-shebang inspector
                journalctl-mode kubernetes-evil link-hint live-py-mode lorem-ipsum
                lsp-origami lsp-treemacs lsp-ui macrostep markdown-toc multi-line
                mwim nameless nov open-junk-file org-cliplink org-contrib
                org-download org-mime org-pomodoro org-present org-projectile
                org-rich-yank org-superstar orgit-forge overseer ox-pandoc
                ...
                rainbow-delimiters restart-emacs ron-mode rustic shfmt smeargle
                space-doc spacemacs-purpose-popwin spacemacs-whitespace-cleanup
                sphinx-doc sql-indent string-edit-at-point string-inflection
                symbol-overlay symon systemd term-cursor toc-org toml-mode
